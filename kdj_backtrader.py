...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        #bt.indicators.CrossOver(self.stoc.lines.percK[i],self.stoc.lines.percD[i])
    ...
    def next(self):
        ...
        crit = any([bt.indicators.CrossOver(self.stoc.lines.percK[i],self.stoc.lines.percD[i] == 1.0) for i in arange(1,11)])
